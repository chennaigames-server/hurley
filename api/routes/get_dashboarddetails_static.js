...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    //   console.log(last_selected_unit);
    ...
    //   player_details.referral_details = referral_details;
    //   player_details.upgr = upgr;
    //   player_details.settings = {
